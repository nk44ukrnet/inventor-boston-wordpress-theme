...
function html5blank_nav()
{
	...
	array(
		...
		'container_id'    => 'main_nav_id',
		'menu_class'      => 'main_header_nav_menu',
		'menu_id'         => 'main_header_nav_menu',
		'echo'            => true,
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="header_nav" class="nav_v2_ul">%3$s</ul>',
		'depth'           => 2,
		'walker'          => ''
		)
	);
...
function html5blank_conditional_scripts()
{
    if (is_page('pagenamehere')) {
        wp_register_script('scriptname', get_template_directory_uri() . '/js/scriptname.js', array('jquery'), '1.0.1'); // Conditional script(s)
...
function html5blank_styles()
{
    ...
    wp_register_style('inventor', get_template_directory_uri() . '/styles/styles.css', array(), '1.0.2', 'all'); //microtime
